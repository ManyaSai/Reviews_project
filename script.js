...
// Function to clear reviews data from local storage
function clearLocalStorage() {
  localStorage.removeItem('reviews');
  reviews = []; // Clear the reviews array as well
}
...
document.getElementById('reviewForm').addEventListener('submit', function (e) {
  ...
  const defaultImageURL = 'front/pics/default_img3.png';
  // Create new review object
  const newReview = {
    id: reviews.length + 1,
    name: name,
    job: job,
    img: defaultImageURL, // Use a default image URL or add user uploaded image URL here
    text: message,
  };
